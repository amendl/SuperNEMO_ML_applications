...
def tf_to_numpy(tensor):
    tensor = tf.reshape(tensor,[116,12])
...
def analyse_event(ID,model,fillers):
    original,truth = clustering_dataset.load_event_helper(ID)
...
if __name__ == "__main__":
    model = keras.models.load_model("../clustering_matteo_with_skip_connection/model")
