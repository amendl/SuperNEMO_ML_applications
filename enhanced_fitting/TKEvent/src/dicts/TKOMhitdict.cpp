...
"/pbs/software/centos-7-x86_64/root/6.22.06-fix01/include/root",
"/sps/nemo/scratch/amendl/AI/real_testing/TKEventEdited/TKEvent/include/",
0
    };
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("TKOMhitdict",
        ...
        TriggerDictionaryInitialization_TKOMhitdict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
